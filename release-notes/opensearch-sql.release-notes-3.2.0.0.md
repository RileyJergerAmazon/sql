...
* Support partial filter push down ([#3850](https://github.com/RileyJergerAmazon/sql/pull/3850))
...
* Fix the count() only aggregation pushdown issue ([#3891](https://github.com/RileyJergerAmazon/sql/pull/3891))
...
* Bump gradle to 8.14 and java to 24 ([#3875](https://github.com/RileyJergerAmazon/sql/pull/3875))
